...
public class SeePayment extends javax.swing.JPanel{
    GetDataFromDatabase getDataFromDatabase=new GetDataFromDatabase();
    DefaultTableModel model1,model2;

    /**
     * Creates new form SeePayment
     */
    public SeePayment() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Enter Payment ID/Method ");
        jLabel14.setToolTipText("");

        DetailsText.setToolTipText("Enter ID/Method to search.");
